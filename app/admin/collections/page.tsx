  ...
  return (
    <div className="p-4 max-w-screen-lg mx-auto">
      <div className="relative overflow-x-auto">
        <table className="w-full text-sm text-left text-slate-500 border border-slate-600 rounded-lg">
          ...
          <tbody>
            <tr className="bg-transparent">
              ...
              >
                <button
                  type="button"
                  className="text-slate-950 bg-transparent border border-slate-900 focus:outline-none hover:bg-slate-900 transition-all duration-300 ease-in hover:text-gray-200 font-semibold text-xs px-5 py-2.5 mr-2 mb-2 "
                >
                  Details
                </button>
              </Link>
