  ...
  return (
    <div className='max-w-screen-xl mx-auto py-8 px-4 text-slate-950'>
      <div> 
        ...
        <h1 className="mb-4 text-3xl font-bold leading-none tracking-tight md:text-3xl lg:text-4xl uppercase"><mark className="px-2 bg-lime-400 rounded-md">Pieces just for you</mark> made for you and done it for you. <br /> Also just 4 you!</h1>
      </div>
        ...
        <div className='flex-1'>     
          ...
          <div className="p-5">
              <span className='uppercase border border-slate-800 text-slate-950 rounded-xl px-2 text-sm font-semibold'></span>
                  ...
                  <p className="my-3 font-medium text-sm text-gray-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi quod, minus iste doloribus, aut cum enim praesentium.</p>
        ...
        <div className='flex-1 w-full'>     
          ...
          <div className="py-4 px-5">
              <span className='uppercase border border-slate-800 text-slate-950 rounded-xl px-2 text-sm font-semibold'></span>
                  ...
                  <div className='mt-4'>
                      <h5 className="mb-2 text-xl font-bold tracking-tight uppercase">Sign in to our newsletter</h5>
                  </div>
